...
//
// Regenerate (should be byte-identical): node fixtures/generate-golden.mjs
...
const treeVectors = trees.map(t => {
  ...
  return {
    ...t,
    preimageBase64: preimage.toString('base64'),
    treeSha: sha256(preimage),
  }
})
